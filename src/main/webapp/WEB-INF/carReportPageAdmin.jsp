...
<head>
    ...
    <style>
        ...
        .action-cell {
            text-align: center;
            padding: 10px;
            width: 150px; /* Expanded column width for buttons */
        }
                ...
                <c:forEach items="${carList}" var="car">
                    <tr class="table-row">
                        ...
                        <td class="action-cell">
                            <a href="carUpdate/${car.carNumber}" class="action-btn update-btn">Update Car</a>
                            <a href="/carDelete/${car.carNumber}" class="action-btn delete-btn">Delete Car</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
